    ...
    <v-row>
      ...
      <v-col sm="12" md="4">
        <base-material-card color="transparent" image hover-reveal>
          <template v-slot:image>
            <v-img
              src="https://prod-ws-solarpower-int-ws-solarpower.azurewebsites.net/img/Solar-Power-Banner-Principal.4d0d2443.png"
            />
          </template>
          ...
          <v-file-input label="Imagen" filled prepend-icon="mdi-camera" />
          <v-text-field label="Title" single-line />
          <v-text-field label="Subtitle" single-line />
        </base-material-card>
      </v-col>
      <v-col cols="12">
        <div
      ...
      <v-col sm="12" md="4">
        <base-material-card color="transparent" image hover-reveal>
          <template v-slot:image>
            <v-img
              src="https://prod-ws-solarpower-int-ws-solarpower.azurewebsites.net/img/solar-power-banner.7f24934e.png"
            />
          </template>
          ...
          <v-file-input label="Imagen" filled prepend-icon="mdi-camera" />
          <v-text-field v-model="data.title" label="Title" single-line />
          <v-text-field v-model="data.subtitle" label="Subtitle" single-line />
        </base-material-card>
      </v-col>
      <v-col sm="12" md="4">
        <base-material-card color="transparent" image hover-reveal>
          <template v-slot:image>
            <v-img
              src="https://prod-ws-solarpower-int-ws-solarpower.azurewebsites.net/img/stick.e9ac566b.png"
              height="250px"
            />
          </template>
          ...
          <v-text-field label="Subtitle" single-line></v-text-field> -->
        </base-material-card>
      </v-col>
      <v-col sm="12" md="4">
        <base-material-card color="transparent" image hover-reveal>
          <template v-slot:image>
            <v-img
              src="https://prod-ws-solarpower-int-ws-solarpower.azurewebsites.net/img/plant1.ce0dbb69.png"
              height="250px"
            />
          </template>
      ...
      <v-col sm="12" md="4">
        <base-material-card color="transparent" image hover-reveal>
          <template v-slot:image>
            <v-img
              src="https://prod-ws-solarpower-int-ws-solarpower.azurewebsites.net/img/planta2.239830d3.png"
              height="250px"
            />
          </template>
